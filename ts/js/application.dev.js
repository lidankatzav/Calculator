...
function add_listeners() {
  ...
  document.getElementById("erase").addEventListener("click", function () {
    return active_calculator_button("erase");
  });
  document.getElementById("pm").addEventListener("click", function () {
    return active_calculator_button("pm");
  });
  ...
  document.getElementById("api").addEventListener("click", function () {
    return change_remote_mode();
  }); // App events

  var id_lst = ["light", "history", "scientific", "api"];

  var _loop_3 = function _loop_3(button_id) {
  ...
  document.getElementById("history").addEventListener("click", function () {
    return visible_or_hidden("history_panel");
  });
  document.getElementById("scientific_panel").style.visibility = "hidden";
  document.getElementById("scientific").addEventListener("click", function () {
    return visible_or_hidden("scientific_panel");
  });
}
